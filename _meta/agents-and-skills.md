...
| `skills/ahead-self-improve.md` | `~/.claude/skills/ahead:self-improve/SKILL.md` |
| `skills/ahead-debugging.md` | `~/.claude/skills/ahead:debugging/SKILL.md` |
| `skills/ahead-tdd.md` | `~/.claude/skills/ahead:tdd/SKILL.md` |
